...
var blog_posts = [
    {
        ...
        <p class="mgt-10">
            So i first started with <a href="https://jquery.com/">jQuery</a> which <b>was</b> really popular, it's so simple & easy to use, you have a large amount of plugins to choose from, i really liked it! Then, arrives the jQuery fall! jQuery was loosing performance especially with the new versions of web browsers & was outdated somehow, in addition that some developers write "spaghetti code" with jquery (i don't do like so 🙄, don't trust me xD), and that gave the opportunity to the new generation of frameworks & libraries to take more place on the market.
        </p>
        <p class="mgt-10">
            I still remember when i first heard about <b>Angular</b>, <b>Backbone.js</b> & <b>Ember.js</b>, i was so curious to know what they have to offer but i never had time & ambition to satisfy my curiosity. Time passed & then i decided to start at least with Angular, i tried Angular 2 which i found great but not so easy to master (need a lot of time & practice). I decided then to look at <b>React</b> which was more simpler somehow but wasn't enough convincing... Okay, till here my last choice was <b>Vue.js</b> right? but i didn't try to look at it! xDD, i thought that it was like the 2 before & i said: "okay, let's wait until i get a real job then i'll choose depending on the job prerequisites."
        </p>
        <p class="mgt-10">
            Once i had a job, i was disappointed 😞 because they wasn't caring about the used technologies more than the results.. In addition that we was mainly working on some old open source projects which certainly use old technologies.. Days passed and i finally got a front-end project to work on! the project was mainly written with AnuglarJS (the 1st & old version of Angular) & was doing some calls to an API to retrieve data, so i started learning <a href="https://angularjs.org/">AngularJS</a>! it was really simple (compared to the others), in less than a week i was able to understand the whole code of the project & in the next week the modifications on the project was done! <b>Happy end!</b> don't you think so? in fact, no.. AngularJS was outdated since Angular 2++ took his place, so continuing to use as such library may be only a waste of time & effort.
        </p>
        <p class="mgt-10">
            Then comes the day when i decided to look at <a href="https://vuejs.org/">Vue.js</a>, i was so impressed how much it was similiar to both AngularJS & React, in fact Vue is practically a merge between Angular & React with a simple advantage that there is no restrictions about the way you want to write your code, so if you are an Angular developer you can still use the old way of AngularJS & if you are coming from the React world you can still use the ES2015 syntax & the JSX power. That's so <b>great</b> & <b>lovely</b>!
        </p>
        `,
        categories: [
            'Front-end',
    ...
    },
    {
        ...
        <p class="mgt-10">
            To try Phoenix OS simply download it & follow the installation steps on the <a href="https://www.phoenixos.com/en/download_x86">official website</a>.
        </p>
        <p class="mgt-10">
    ...
    },
    {
        ...
        <p class="mgt-10">
            <img src="img/posts/osticket-theme.png" alt="osTicket" />
        </p>
        <p class="mgt-10">
    ...
    },
    {
        ...
        <p class="mgt-10">
            <img src="img/posts/ldap-auth.jpg" alt="LDAP" />
        </p>
        <p class="mgt-10">
    ...
    },
    {
        ...
        date: 'May 25, 2019',
        author: 'AXeL',
        image: 'img/posts/gitflow-mini.png',
        text: `
        <p>
    ...
    },
    {
        ...
        date: 'May 18, 2019',
        author: 'AXeL',
        image: 'img/posts/freelancer.jpg',
        text: `
        <p>
    ...
    },
    {
        ...
        date: 'March 27, 2019',
        author: 'AXeL',
        image: 'img/posts/php-vs-node.jpg',
        text: `
        <p>

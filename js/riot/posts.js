...
var blog_posts = [
    {
        ...
        <p class="mgt-10">
            The point is if you don't work hard to achieve your dreams, someone else will hire you to achieve theirs. And when it comes to dreams they could ask you to build a plane while you don't even know how to build a car.. You get me now?
        </p>
        <p class="mgt-10">
        ...
        <ul class="disc-list mgt-10">
            <li><b>No guarantee</b> (it's not easy to find some tasks or projects to work on)</li>
            <li><b>Laziness</b>, wasting time sleeping or doing nothing.. (just do something ! doing some sports, yoga or any kind of activity could help)</li>

...
var blog_posts = [
    {
        ...
        <br>
        <p>
            What makes Riot so interesting?<br>
            <ul class="disc-list">
        ...
        <br>
        <p>
            As a developer one of the main problems i face with new technologies is the learning curve, and after spending time on learning something new there is no guarantee that you will find some projects to work on with the technologies you just learned, you may be just wasting time on learning something you won't use.
            This is why i'm trying to focus more on my choices & this is why i chose Riot ;)
        </p>
        <br>
        <p>
            Convinced & want to give it a try? here you go!<br>
            <iframe src="https://riot.js.org/examples/live-editor/"></iframe>
        </p>
        <br>
        <p>
            I recently introduced Riot to my portfolio, you will find the full source code <a href="https://github.com/AXeL-dev/portfolio" target="_blank">here</a> (it stills not the best example out there).
        </p>
        `,
        categories: [
            'Front End',
    ...
    },
    {
        ...
        <br>
        <p>
            Version 4 is a complete rewrite of the framework, so let's check what's new:<br><br>
            <ul class="disc-list">
                <li>
                ...
                <li class="bold-text">Support for newer PHP versions & functionalities</li>
            </ul>
        </p>
        <br>
        <p>
            <span class="bold-text">Note</span>: version 4 is currently in the beta stage, wich means that it's not yet ready for production, but it won't last for long.
        </p>
        `,
        categories: [
            'Back End',
